      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form>
                @csrf
                <div class="mb-3">
                    <label for="NamBarList" class="form-label">Nama Barang</label>
                ...
                <div class="mb-3">
                    <label for="pilihanUkuran" class="form-label">Ukuran Barang</label>
                ...
                <div class="mb-3">
                    <label for="iniQty" class="form-label">Jumlah Barang</label>
                    <input type="number" class="form-control" id="iniQty" value="1">
                </div>         
                <div class="mb-3">
                    <label for="subTotal" class="form-label">Total harga</label>
                    <input type="text" class="form-control" id="subTotal" value="60000" readonly>
                </div>         
            </form>
        </div>
