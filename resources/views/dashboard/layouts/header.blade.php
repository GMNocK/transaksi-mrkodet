<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
	<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-center" href="/dashboard">Mister Kodet</a>
	...
	{{-- <div class="navbar d-flex justify-content-center align-items-center">
		<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 w-100 navbar-search">
		...
		<div class="nav-item text-nowrap">
			...
			<form action="/logout" method="post">
				...
				<button class="nav-link px-3 bg-dark border-0" >
					Logout
					<span data-feather="log-out" style="margin-right: 5px"></span>
				</button>
			</form>
		</div>
	</div>
